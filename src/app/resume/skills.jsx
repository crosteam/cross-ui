...
import Inputs from "../../components/motion/inputs";
                                    ...
                                    >
                                        ...
                                        {cv.toolsAndTechSkills.map((tag, index) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    <RiCloseFill
                                                        className="tagDeleteButton fill-blue-400 hover:fill-blue-700 hover:bg-blue-300/50"/>
                                                </motion.button>
                                            </motion.div>
                                        ))}
                                        <motion.input
                                    ...
                                    >
                                        ...
                                        {cv.industryKnowledge.map((tag, index) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    <RiCloseFill
                                                        className="tagDeleteButton fill-violet-400 hover:fill-violet-700 hover:bg-violet-300/50"/>
                                                </motion.button>
                                            </motion.div>
                                        ))}
                                        <motion.input
                                    ...
                                    >
                                        ...
                                        {cv.languages.map((tag, index) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    <RiCloseFill
                                                        className="tagDeleteButton fill-rose-400 hover:fill-rose-700 hover:bg-rose-300/50"/>
                                                </motion.button>
                                            </motion.div>
                                        ))}
                                        <motion.input
