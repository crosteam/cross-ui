...
import {HiExternalLink, HiOutlineBriefcase, HiOutlineCalendar, HiOutlineLink, HiOutlineMail,} from "react-icons/hi";
                        ...
                        <section className="mt-6">
                          ...
                          {experience.startDate || experience.endDate ? (
                              <HiOutlineCalendar className="inline"/>
                                            ...
                                            <ReactMarkdown
                                                className="myList relative text-[0.705rem] mb-2 mt-2 text-gray-700 ">
                                                {experience.summary}
                                            </ReactMarkdown>
                                        </div>
                                    );
