...
import {HiExternalLink, HiOutlineLink, HiOutlineMail} from "react-icons/hi";
...
import {resolvedWebsiteLink, websiteLinkCreator} from "../../utils/link.utils";
                        ...
                        <div key={index}>
                            ...
                            <section className="mt-6 relative">
                                ...
                                <div className="absolute -left-[29px] top-[7px]">
                                    <div
                                        className=" absolute rounded-sm rotate-45 h-3 w-3 ring-4 ring-white bg-black "/>
                                ...
                                {item.experiences.map((experience, index) => {
                                    return (
                                        <div className="relative " key={index}>
                                            <div
                                                className="absolute ring-4 ring-white -left-[24px]  h-[93%] top-1 rounded-md px-[1px] bg-black "/>
                                ...
                                {item.projects.map((project, index) => {
                                    return (
                                        <div key={index} className="mt-2 relative">
                                            <div
                                                className="absolute border ring-4 ring-white border-black  -left-[25px]  h-[50px] top-1 rounded-md px-[1px] bg-white "/>
                                            <h4 className="font-medium text-md">
