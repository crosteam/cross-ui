...
const PageButtons = () => {
    ...
    return (
        <div
            className="z-10 text-neutral-500 flex items-center w-fit md:left-[26.5rem] md:right-0 mx-auto text-center backdrop-blur-2xl bg-white/50 border border-black/10 px-5 py-3 space-x-5 transition-all rounded-full">
